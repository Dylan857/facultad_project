...
class Tutoria(Base): 
    ...
    tema_desarrollar = Column(String(30), nullable=False)
    ...
    def __init__(self, docente_id, fecha, hora_inicio, hora_fin, asignatura_id, tema_desarrollar):
        self.docente_id = docente_id
        self.fecha = fecha
        self.hora_inicio = hora_inicio
        self.hora_fin = hora_fin
        self.asignatura_id = asignatura_id
        self.tema_desarrollar = tema_desarrollar